...
public class SpringConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            dataSource.setDriverClass("spring.datasource.driverClass");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        hibernateProperties.setProperty("hibernate.dialect", "hibernate.factory.dialect");
        hibernateProperties.setProperty("hibernate.show_sql", "hibernate.factory.show_sql");
